...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
    <a class="navbar-brand" href="#">Piseth</a>
...
`
document.querySelector(".nav-bar").innerHTML = navba;
...
for (let i=0; i<data.length; i++){
  ...
  <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3">
    <div class="card">
        <img src="${photo[i].thumbnailUrl}" class="card-img-top" alt="...">
            <div class="card-body">
...
document.querySelector(".card-box").innerHTML = card;
